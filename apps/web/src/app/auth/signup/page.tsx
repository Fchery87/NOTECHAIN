    ...
    return (
      <div className="min-h-screen bg-stone-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow-sm border border-stone-200 rounded-2xl sm:px-10 text-center">
            ...
            <h2 className="text-2xl font-medium text-stone-900 mb-2">Account created!</h2>
    ...
    <div className="min-h-screen bg-stone-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-sm border border-stone-200 rounded-2xl sm:px-10">
          <h2 className="text-2xl font-medium text-stone-900 mb-2">Create your account</h2>
          <p className="text-sm text-stone-600 mb-6">
            Start your private, encrypted note-taking journey.
          </p>
