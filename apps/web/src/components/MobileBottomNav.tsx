...
export default function MobileBottomNav() {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#0a0a0a]/95 backdrop-blur-md border-t border-stone-800 pb-[env(safe-area-inset-bottom)]">
      <div className="flex items-center justify-start overflow-x-auto gap-2 px-4 py-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        {navItems.map(item => {
