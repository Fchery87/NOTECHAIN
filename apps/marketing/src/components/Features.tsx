const features = [
  ...
  },
  {
    ...
    description:
      'Share encrypted workspaces with your team. Control permissions and collaborate in real-time.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'Visualize connections between your notes. Discover relationships and insights automatically.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'Record and transcribe meetings automatically. Get searchable transcripts linked to your notes.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'Extract text from images and scanned documents. Convert photos into searchable, editable notes.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    title: 'PDF Studio',
    description:
      'View, annotate, sign, and extract text from PDFs. Perfect for contracts and documents.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    title: 'Voice Input',
    description:
      'Dictate notes hands-free. AI-powered transcription converts your speech into text instantly.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description:
      'Track changes to your notes over time. Restore previous versions with a single click.',
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: 'Full-text search across notes, tasks, and documents. Find anything in seconds.',
  },
];
